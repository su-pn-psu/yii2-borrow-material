...
/**
 * StdBelongtoSearch represents the model behind the search form about `suPnPsu\borrowMaterial\models\StdBelongto`.
 */
class StdBelongtoSearch extends StdBelongto
{
    /**
     * @inheritdoc
     */
