...
/**
 * StdPositionSearch represents the model behind the search form about `backend\modules\borrowreturn\models\StdPosition`.
 */
class StdPositionSearch extends StdPosition
{
    /**
     * @inheritdoc
     */
