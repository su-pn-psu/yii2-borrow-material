...
class BookingController extends Controller
{
    ...
    public function actionView($id)
    {
        ...
        Yii::$app->view->title = Yii::t('borrow-material', 'ดูรายละเอียด') . ' : ' . $model->id . ' - ' . Yii::t('borrow-material', Yii::$app->controller->module->params['title']);
...
//        }
    ...
    public function actionDelete($id)
    {
        ...
        Yii::$app->getSession()->setFlash('edtflsh', [
            ...
            'duration' => 4000,
            'icon' => 'glyphicon glyphicon-ok-circle',
            'message' => Yii::t('borrow-material', 'ลบข้อมุลเรียบร้อย'),
        ]);
